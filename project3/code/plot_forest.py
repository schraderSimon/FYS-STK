...
test_data=np.loadtxt("../csvdata/randomforest_3.16e+03test%s.csv"%type,skiprows=1,dtype="float",delimiter=",")
train_data=np.loadtxt("../csvdata/randomforest_3.16e+03train%s.csv"%type,skiprows=1,dtype="float",delimiter=",")
...
plt.tight_layout()
plt.savefig("../figures/forest%s.pdf"%type)
plt.show()
"""
python3 plot_forest.py
"""
