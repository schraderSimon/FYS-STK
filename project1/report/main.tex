...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figures/presentable_data/MSE_different_methods_Korea50000_NOBOOTSTRAP.pdf}
\caption[Test MSE for LASSO, Rigde and OLS regression]{Test MSE for LASSO, Rigde and OLS regression. Estimated using 5-Fold Cross validations. The exact parameters can be found in the graph's title. LASSO regression did not converge.}
