...
All programs can be found on our \href{https://github.com/schraderSimon/FYS-STK/tree/master/project2}{Github address}. In the main folder, an explanation of the code can be found with an overview of the folder structure.
