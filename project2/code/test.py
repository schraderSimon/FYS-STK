...
class ONeuralNetwork:
    ...
    def create_biases_and_weights(self):
        self.hidden_weights = np.random.randn(self.n_features, self.n_hidden_neurons)*0.1
        self.hidden_bias = np.zeros(self.n_hidden_neurons) + 0.01

        self.output_weights = np.random.randn(self.n_hidden_neurons, self.n_categories)*0.1
...
clf = MLPClassifier(max_iter=epochs,activation='relu',solver="adam",hidden_layer_sizes=n_hidden_neurons,learning_rate_init=eta).fit(X_train, Y_train)
